  ...
  return (
    <section className="relative flex min-h-[calc(100vh-118px)] w-full items-center justify-center overflow-hidden">
      <motion.div
        ...
        className="relative mx-auto w-full max-w-[1180px] px-4 lg:px-6"
      >
        ...
        <div className="mb-5 flex items-start justify-between gap-4">
          <motion.div
            ...
            transition={{ delay: 0.08, ...shellTransition }}
          >
        ...
        <div className="grid gap-5 lg:grid-cols-[1.05fr_0.95fr]">
          <motion.div
            initial={{ opacity: 0, x: -55, y: 18, rotate: -1.4, scale: 0.97 }}
            animate={{ opacity: 1, x: 0, y: 0, rotate: 0, scale: 1 }}
            transition={{ delay: 0.14, ...shellTransition }}
            className="group relative overflow-hidden rounded-[30px] border border-white/14 bg-[linear-gradient(180deg,rgba(255,255,255,0.09),rgba(255,255,255,0.035))] p-5 shadow-[0_24px_80px_rgba(0,0,0,0.34),inset_0_1px_0_rgba(255,255,255,0.07)] backdrop-blur-2xl lg:p-6"
          >
            ...
            <div className="relative">
              ...
              <form className="grid gap-3.5">
                <input
                  type="text"
                  placeholder="Nombre"
                  className="h-11 rounded-2xl border border-white/10 bg-black/20 px-4 text-sm text-white outline-none transition duration-300 placeholder:text-white/32 focus:border-white/28 focus:bg-white/[0.07] focus:shadow-[0_0_0_1px_rgba(255,255,255,0.06),0_0_24px_rgba(143,92,255,0.16)]"
                />
                ...
                <textarea
                  ...
                  className="min-h-[110px] rounded-2xl border border-white/10 bg-black/20 px-4 py-3.5 text-sm text-white outline-none transition duration-300 placeholder:text-white/32 focus:border-white/28 focus:bg-white/[0.07] focus:shadow-[0_0_0_1px_rgba(255,255,255,0.06),0_0_24px_rgba(143,92,255,0.16)]"
                />
          ...
          <motion.div
            initial={{ opacity: 0, x: 55, y: 18, rotate: 1.4, scale: 0.97 }}
            animate={{ opacity: 1, x: 0, y: 0, rotate: 0, scale: 1 }}
            transition={{ delay: 0.2, ...shellTransition }}
            className="group relative overflow-hidden rounded-[30px] border border-white/14 bg-[linear-gradient(180deg,rgba(255,255,255,0.085),rgba(255,255,255,0.03))] p-5 shadow-[0_24px_80px_rgba(0,0,0,0.34),inset_0_1px_0_rgba(255,255,255,0.07)] backdrop-blur-2xl lg:p-6"
          >
            <div className="pointer-events-none absolute inset-0">
            ...
            <div className="relative">
              ...
              <div className="grid gap-3">
                {serviceOptions.map((item, index) => (
                  <motion.label
                    ...
                    className="group/option flex cursor-pointer items-center gap-3 rounded-[22px] border border-white/10 bg-white/[0.04] px-4 py-3.5 text-white/82 transition duration-300 hover:-translate-y-[2px] hover:border-white/20 hover:bg-white/[0.08] hover:shadow-[0_10px_28px_rgba(167,110,255,0.14)]"
                  >
                    <input
                      type="radio"
                      name="service"
              ...
              <motion.div
                ...
                transition={{ delay: 0.42, ...shellTransition }}
