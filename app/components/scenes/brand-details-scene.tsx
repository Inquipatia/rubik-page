          ...
          <div className="relative z-10 flex flex-col gap-4">
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <h2 className="omnes-title mt-2 text-[1.9rem] leading-none tracking-[-0.03em] text-white sm:text-[2.2rem] lg:text-[2.6rem]">
                    {brandName}
                  </h2>
                </div>
              </div>
              ...
              {brandLogo && (
                <div className="relative h-8 w-24 shrink-0 opacity-90 lg:h-8 lg:w-24">
                  <Image
                    src={brandLogo}
                    alt={brandName}
                    fill
            ...
            <div className="grid items-stretch gap-4 lg:grid-cols-[580px_minmax(0,1fr)] lg:justify-between">
              <div className="relative h-[390px] overflow-hidden rounded-[22px] border border-white/12 bg-black/20 lg:h-[620px] lg:w-[580px]">
                ...
                >
                  ...
                  <div className="pointer-events-none absolute inset-x-0 bottom-0 z-10 p-5 sm:p-6">
                    <h3 className="omnes-title text-[1.75rem] tracking-[-0.03em] text-white sm:text-[1.9rem] lg:text-[2rem]">
                      {activeWork.title || brandName}
                    </h3>
              ...
              <div className="grid h-[390px] gap-4 lg:h-[620px] lg:grid-rows-[280px_minmax(0,1fr)]">
                ...
                <div className="flex min-h-0 flex-col overflow-hidden rounded-[22px] border border-white/12 bg-white/[0.055] p-3.5 lg:p-4">
                  <div className="mb-3">
